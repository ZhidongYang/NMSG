...
class DnCNN(nn.Module):
    def __init__(self, channels, num_of_layers=17):
        ...
        for _ in range(num_of_layers-2):
            ...
            layers.append(nn.ReLU(inplace=True))
        layers.append(nn.Conv3d(in_channels=features, out_channels=channels, kernel_size=kernel_size, padding=padding, bias=False))
...
class IRCNN(nn.Module):
    def __init__(self, channels):
        ...
        layers.append(nn.Conv3d(in_channels=channels, out_channels=features, kernel_size=kernel_size, stride=1, padding=1, dilation=1, bias=True))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.Conv3d(in_channels=features, out_channels=features, kernel_size=kernel_size, stride=1, padding=2, dilation=2, bias=True))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.Conv3d(in_channels=features, out_channels=features, kernel_size=kernel_size, stride=1, padding=3, dilation=3, bias=True))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.Conv3d(in_channels=features, out_channels=features, kernel_size=kernel_size, stride=1, padding=4, dilation=4, bias=True))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.Conv3d(in_channels=features, out_channels=features, kernel_size=kernel_size, stride=1, padding=3, dilation=3, bias=True))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.Conv3d(in_channels=features, out_channels=features, kernel_size=kernel_size, stride=1, padding=2, dilation=2, bias=True))
        layers.append(nn.ReLU(inplace=True))
        layers.append(nn.Conv3d(in_channels=features, out_channels=channels, kernel_size=kernel_size, stride=1, padding=1, dilation=1, bias=True))
